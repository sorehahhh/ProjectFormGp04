...
Public Class StudentGroupListForm
    ...
    Private Sub StudentGroupDataGridView_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles StudentGroupDataGridView.CellContentClick
